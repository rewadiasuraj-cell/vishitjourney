...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  /* ── MAIN CONTENT ── */
  .contact-container{max-width:1150px;margin:2rem auto 5rem;padding:0 1.5rem;display:grid;grid-template-columns:1fr 1.3fr;gap:3rem}
...
<body>
  ...
  <nav>
    <a href="index.php" class="logo">
      <img src="Vishit_Journey_Logo.jpg" alt="Vishit Journey" style="height:64px;width:auto;display:block;mix-blend-mode:multiply;">
    </a>
    <ul class="nav-links">
